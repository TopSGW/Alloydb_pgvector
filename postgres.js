...
const getAlloyDBClient = () => {
  ...
  //   `postgresql://${process.env.ALLOY_DB_USER}:${process.env.ALLOY_DB_PASSWORD}@${process.env.ALLOY_DB_HOST}:${process.env.ALLOY_DB_PORT || 5432}/${process.env.ALLOY_DB_DBNAME}?`;
